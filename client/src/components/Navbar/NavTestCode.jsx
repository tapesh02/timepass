            ...
            <div className="showNavDesktop">
                <div className="nav_main">
                    ...
                    <div className="nav_menu">
                        <NavLink exact activeClassName="active_link" to="/home" className="navitems">
                            Home
                        </NavLink>
                        <NavLink exact activeClassName="active_link" to="/movies" className="navitems">
                            Movies
                        </NavLink>
                        <NavLink exact activeClassName="active_link" to="/tvshows" className="navitems">
                            TV Seasons
                        </NavLink>
                        <NavLink exact activeClassName="active_link" to="/about" className="navitems">
                            About
                        </NavLink>
