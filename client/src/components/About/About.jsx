      ...
      <section>
        ...
        <div className="about-main">
          ...
          <div className="about-details">
            <p>
              Hello and welcome to MovieHunt, the place to find the best rated
              movies, tv shows and tarilers for every taste and occasion. We
              thoroughly check the quality of our movie prints, working only
              with reliable suppliers so that you only receive the best quality
              service. We at MovieHunt believe in high quality and exceptional
              customer service. Most importantly, we consider entertainment as a
              right, not an extravagance, so we strive to provide the best
              experience at no cost, because we believe that entertainment is a
              joy, and everyone deserves to share cherished memories with
